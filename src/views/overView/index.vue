    ...
    <div class="overview-container">
      ...
      <section class="basic-info section">
        ...
        <ul class="info-list">
          ...
          <li><span class="label">登场作品：</span>轻小说《约会大作战》及其衍生作品</li>
        </ul>
      </section>
      ...
      <section class="powers section">
        ...
        <ul class="powers-list">
          <li>
            <strong>灵装</strong>：神威灵装·三番（Elohim），哥特风洋装与修道服融合，能吸收灵结晶增强形态。
          </li>
          <li>
            <strong>天使</strong>：刻刻帝（Zafkiel），巨大时钟形态，长短针为古式步枪与手枪，子弹拥有各种能力。
          </li>
        </ul>
      </section>
      ...
      <section class="skills section">
        ...
        <ul class="skills-list">
          ...
          <li><strong>Yud-Aleph（十一之弹）</strong>：吞噬灵力后送目标至未来。</li>
          <li><strong>Yud-Bet（十二之弹）</strong>：吞噬灵力后送目标至过去，可多重分身。</li>
        </ul>
      </section>
